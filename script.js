...
function sortTable(sortBy) {
    var row = document.getElementById("demo").rows; // this pulls all the rows of the table we're sorting
    ...
    while (switching) {
        ...
        for(rowNum = 0; rowNum < (row.length - 1); rowNum++) {
            ...
            currentRow = row[rowNum].getElementsByTagName("td")[sortBy];
            nextRow = row[rowNum + 1].getElementsByTagName("td")[sortBy];
